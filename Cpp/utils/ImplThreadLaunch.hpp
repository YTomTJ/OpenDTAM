...
namespace ImplThread {
    ...
    unsigned int startThread(
        void (*_func)(int *), const std::string &_name = "ODMThread", int affinity = -1);
} // namespace ImplThread
...
public:
    static unsigned int startThread(Object &object, void (Object::*_func)(int *),
        const std::string &_name = "ODMThread", int affinity = -1)
    {
